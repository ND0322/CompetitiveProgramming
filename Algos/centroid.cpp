...
build centroid decomp
for centroid node store the distance to the closest node in its component
update: walk up ancestors and compare this to the old component node and the distance
query: walk up ancestors which will all be lcas between the answer stored node and queried node
*/
